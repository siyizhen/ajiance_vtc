<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"E:\www\ajiance_vct/app/home\view\index_index.html";i:1515234151;s:49:"E:\www\ajiance_vct/app/home\view\common_head.html";i:1515234151;s:51:"E:\www\ajiance_vct/app/home\view\common_footer.html";i:1515234151;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="camera_wrap" id="camera-slide">
        ...
        <div data-src="__HOME__/images/slideshow/bg-slide1.jpg">
            ...
            <div class="caption-type1 moveFromRight">
                <img src="__PUBLIC__<?php echo $vo['pic']; ?>" alt="<?php echo $vo['name']; ?>" />
            </div>
        </div>
        <?php elseif($i == 2): ?>
        <!-- slide 2 here -->
        ...
        <div class="three columns mobile-two">
            ...
            <div class="link-url">
                <a href="<?php echo url('home/'.$vo['catdir'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" target="_blank" title="<?php echo $vo['title']; ?>">
                    <img src="<?php echo imgUrl($vo['title_thumb'],__HOME__.'/images/portfolio-thumb/p'.$k.'.jpg'); ?>" alt="<?php echo $vo['title']; ?>" class="fade" />
                </a>
            </div>
        </div>
        <?php endforeach ?>
    ...
    <div id="featured-wrapper2">
        <div class="row front-feature-icon">
            ...
            <div class="four columns mobile-one">
                <img src="__HOME__/images/sample-images/front-icon<?php echo $k+1; ?>.png" alt="<?php echo $list['title']; ?>" class="img-center" />
