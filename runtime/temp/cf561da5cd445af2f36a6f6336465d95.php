<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"F:\www\php/app/homeadmin\view\index\add.html";i:1515478150;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<script type="text/javascript">
			...
			function submits(){
				...
				$.ajax({
					...
					url: "<?php echo url('homeadmin/index/add'); ?>",
					type: 'POST',
					dataType: 'json',
					...
					success:function(res){
						layer.open({content:'采集成功！',skin:'footer'});
						setTimeout(function(){
							location.reload();
						},1000);
					},
